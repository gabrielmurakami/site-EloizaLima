...
const Hero = () => {
  return (
    <section
      id="inicio"
      className="section-padding pt-32 bg-gradient-to-b from-background via-background to-secondary/30"
    >
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-10 animate-fade-in">
            <div className="space-y-6">
              ...
              <p className="text-xl md:text-2xl text-foreground leading-relaxed font-light max-w-lg">
