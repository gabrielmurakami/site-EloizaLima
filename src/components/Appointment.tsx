...
const Appointment = () => {
  return (
    <section id="agendamento" className="section-padding bg-gradient-to-br from-background to-secondary/30">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-white p-8 rounded-3xl border border-border/50 hover:shadow-lg smooth-transition group">
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <h3 className="font-serif text-xl text-foreground">Calendly</h3>
                  <p className="text-muted-foreground font-light">
            ...
            <div className="bg-white p-8 rounded-3xl border border-border/50 hover:shadow-lg smooth-transition group">
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <h3 className="font-serif text-xl text-foreground">E-mail</h3>
                  <p className="text-muted-foreground font-light">
                    Contato por e-mail
                  </p>
                </div>
                <Button 
                  variant="outline" 
                  className="w-full rounded-2xl h-12 border-border/50 hover:bg-accent"
            ...
            <div className="grid md:grid-cols-4 gap-8">
              <div className="text-center space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground text-sm font-light">Entre em contato por uma das opções</p>
                </div>
              </div>
              <div className="text-center space-y-4">
                <div className="w-12 h-12 bg-primary/10 rounded-2xl flex items-center justify-center mx-auto">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground text-sm font-light">Conversaremos sobre suas necessidades</p>
                </div>
              </div>
              <div className="text-center space-y-4">
                <div className="w-12 h-12 bg-primary/10 rounded-2xl flex items-center justify-center mx-auto">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground text-sm font-light">Escolheremos data e horário</p>
                </div>
              </div>
              <div className="text-center space-y-4">
                <div className="w-12 h-12 bg-primary/10 rounded-2xl flex items-center justify-center mx-auto">
                  <span className="text-primary font-medium text-lg">4</span>
                </div>
                <div className="space-y-2">
                  <h4 className="font-medium text-foreground">Consulta</h4>
                  <p className="text-muted-foreground text-sm font-light">Seu primeiro passo rumo ao bem-estar</p>
                </div>
              </div>
            </div>
          </div>
